...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_PEEP_DEBUG_HEADING_TO_RIDE = 7021,
        STR_PEEP_DEBUG_HAS_MAP = 7022,
        STR_PEEP_DEBUG_TRANSPORT_SHORTCUT = 7023,
        STR_PEEP_DEBUG_ORIGINAL_GOAL = 7024,
        STR_PEEP_DEBUG_MAP_YES_ASTAR = 7025,
        STR_PEEP_DEBUG_MAP_YES = 7026,
        STR_PEEP_DEBUG_MAP_NO = 7027,
        STR_PEEP_DEBUG_TRANSPORT_ACTIVE = 7028,
        STR_PEEP_DEBUG_TRANSPORT_NONE = 7029,
